...
parser.add_argument('action', choices=['activate', 'deactivate'], help="The action to perform.")
parser.add_argument('slice', help="The name of the slice to target.")
parser.add_argument('--host', default='127.0.0.1', help='IP address of the REST controller.')
parser.add_argument('--port', default=8080, type=int, help='Port of the REST controller.')
